...
namespace TriDimensionalChess.UI {
	...
	public class PlayerControls : MonoBehaviour {
		...
		public void ResignGame() =>
			Game.Game.Instance.State = _isWhitePieces ? GameState.WHITE_RESIGNATION : GameState.BLACK_RESIGNATION;

		///<summary>
		///Offer a draw to the opposing player
		///</summary>
		public void RequestDraw() {
			if (HasDrawOffer) Game.Game.Instance.State = GameState.DRAW_MUTUAL_AGREEMENT;
			else Game.Game.Instance.OfferDraw(!_isWhitePieces);
